...
void main()
{	
	int shadowOffset = skeletonID[gl_DrawID] == -1 ? 6 : 0;
	gl_Position = shadowBuffers[ShadowIndex].lightPV[gl_InstanceID] * propBuffer[propIndex[gl_DrawID]].bBoxMatrix * vec4(vertex, 1.0);		
