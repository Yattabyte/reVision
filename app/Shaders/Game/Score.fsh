...
{		
	...
	//vec4 DigitModifier = vec4(mix( mix(vec3(0,0.5,1), vec3(1,0,0.5), sin(((gl_FragCoord.x / CameraDimensions.x) * 6.0f) + (2.0f * (float(gameTick) / SCORE_ROTATE_TICK) - 1.0f) * 3.1415f)), vec3(0,1,0),HighlightAmount),1);
