...
public:
	...
	static void Create(Engine * engine, Shared_Asset_Collider & userAsset, const std::string & filename, const bool & threaded = true);
...
private:
	...
	static void Initialize(Engine * engine, Shared_Asset_Collider & userAsset, const std::string & fullDirectory);
	/** Finalizes the asset. */
