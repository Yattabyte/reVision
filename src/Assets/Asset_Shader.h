...
public:	
	...
	***********************************************************************/
	...
	void setUniform(const GLuint & i, const unsigned int & o) { glProgramUniform1ui(m_glProgramID, i, o); }
	...
	void setUniform(const GLuint & i, const unsigned int * o) { glProgramUniform1uiv(m_glProgramID, i, 1, o); }
	...
	void setUniformArray(const GLuint & i, const unsigned int & o, const int & size) { glProgramUniform1uiv(m_glProgramID, i, size, &o); }
