...
// Easing Functions
inline static constexpr auto easeOutBounce = [](float t) {
	if (t < (1.0f / 2.75f))
		return (7.5625f * t *t);
...
inline static constexpr auto easeInBounce = [](float t) {
	return 1.0f - easeOutBounce(1.0f - t);
};
inline static constexpr auto smoothStart2 = [](const float & t) {
	return t * t;
};
inline static constexpr auto smoothStart3 = [](const float & t) {
	return t * t * t;
};
inline static constexpr auto smoothStart4 = [](const float & t) {
	return t * t * t * t;
};
inline static constexpr auto smoothStart5 = [](const float & t) {
	return t * t * t * t * t;
};
...
inline static constexpr auto swapTiles = [](const auto & coordsA, const auto & coordsB, Board_Component & board) {
