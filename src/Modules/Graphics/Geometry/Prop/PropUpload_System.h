...
public:
	...
	/** Destroy this system. */
	inline ~PropUpload_System() noexcept {
...
private:
	...
	inline void tryInsertModel(const Shared_Model& model) noexcept {
	...
	inline void tryInsertMaterial(const Shared_Material& material) noexcept {
